...
def run_get_batch(
    ...
    from cs336_basics.train_lm import get_batch
...
def run_cross_entropy(inputs: Float[Tensor, " batch_size vocab_size"], targets: Int[Tensor, " batch_size"]) -> Float[Tensor, ""]:
    ...
    from cs336_basics.train_lm import cross_entropy
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    from cs336_basics.train_lm import gradient_clipping
...
def get_adamw_cls() -> type[torch.optim.Optimizer]:
    ...
    from cs336_basics.train_lm import AdamW
...
def run_get_lr_cosine_schedule(
    ...
    from cs336_basics.train_lm import cosine_annealing_lr_schedule
...
def run_save_checkpoint(
    ...
    from cs336_basics.train_lm import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from cs336_basics.train_lm import load_checkpoint
